        ...
        <form action="#">
            <div class="grid grid-cols-6 gap-6">
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" name="name" value = "{{$product -> name}}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-customPink focus:border-customPink block w-full p-2.5" placeholder="" required="">
                </div>
                <div class="col-span-6 sm:col-span-3">
                    <label for="price" class="text-sm font-medium text-gray-900 block mb-2">Price</label>
                    <input type="text" name="price" value = "{{$product -> price}}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-customPink focus:border-customPink block w-full p-2.5" placeholder="50.20" required="">
                </div>
                <div class="col-span-6 sm:col-span-3">
                    <label for="description" class="text-sm font-medium text-gray-900 block mb-2">Description</label>
                    <input type="text" name="description"  value = "{{$product -> description}}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-customPink focus:border-customPink block w-full p-2.5" placeholder="" required="">
                </div>
                <div class="col-span-6 sm:col-span-3">
                    <label for="feature_image" class="text-sm font-medium text-gray-900 block mb-2">Feature Image</label>
                    <input type="text" name="feature_image" value = "{{$product -> feature_image}}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-customPink focus:border-customPink block w-full p-2.5"  required="">
                </div>
                <div class="col-span-6 sm:col-span-3">
                    <label for="gallery_image" class="text-sm font-medium text-gray-900 block mb-2">Gallery Image</label>
                    <input type="text" name="gallery_image" value = "{{$product -> gallery_image}}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-customPink focus:border-customPink block w-full p-2.5"  required="">
                </div>
                <div class="col-span-6 sm:col-span-3">
                    <label for="shipping_cost" class="text-sm font-medium text-gray-900 block mb-2">Shipping Cost</label>
                    <input type="text" name="shipping_cost"  value = "{{$product -> shipping_cost}}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-customPink focus:border-customPink block w-full p-2.5"  required="">
                </div>
